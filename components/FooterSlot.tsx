 ...
 *
 * At every width. It was hidden on phones for a while because the long intro
 * paragraph sat in normal flow at the foot of the threshold and the two
 * collided. That paragraph is gone, so the band is free and the entry page
 * keeps its one way to reach the studio on every screen.
 *
