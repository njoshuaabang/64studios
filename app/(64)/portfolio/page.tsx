...
export const metadata: Metadata = {
  ...
  description:
    "Websites for an interior design studio and a private house in Marylebone, designed and built by 64 Studios.",
...
export default function PortfolioPage() {
  return (
    <main id="main-content" tabIndex={-1} className="mx-auto max-w-6xl px-4 pb-16 pt-16 md:px-6 md:pt-20">
      ...
      <p className="mt-4 max-w-[52ch] font-body text-base leading-relaxed text-ink">
        Two ways of showing a house: through the studio that designed it, and through the house
        itself.
      </p>
